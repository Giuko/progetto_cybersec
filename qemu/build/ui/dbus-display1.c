...
static const GDBusAnnotationInfo _qemu_dbus_display1_audio_property_nsamples_annotation_info_0 =
{
  -1,
...
static const GDBusAnnotationInfo * const _qemu_dbus_display1_audio_property_nsamples_annotation_info_pointers[] =
{
  &_qemu_dbus_display1_audio_property_nsamples_annotation_info_0,
  NULL
};

static const _ExtendedGDBusPropertyInfo _qemu_dbus_display1_audio_property_info_nsamples =
{
  {
    -1,
    (gchar *) "NSamples",
    (gchar *) "u",
    G_DBUS_PROPERTY_INFO_FLAGS_READABLE,
    (GDBusAnnotationInfo **) &_qemu_dbus_display1_audio_property_nsamples_annotation_info_pointers
  },
  "nsamples",
  FALSE,
  FALSE
...
{
  &_qemu_dbus_display1_audio_property_info_nsamples.parent_struct,
...
{
  g_object_class_override_property (klass, property_id_begin++, "nsamples");
  g_object_class_override_property (klass, property_id_begin++, "interfaces");
  return property_id_begin - 1;
}
 ...
 * @get_nsamples: Getter for the #QemuDBusDisplay1Audio:nsamples property.
 *
...
qemu_dbus_display1_audio_default_init (QemuDBusDisplay1AudioIface *iface)
{
  ...
  /* GObject properties for D-Bus properties: */
  /**
   * QemuDBusDisplay1Audio:nsamples:
   *
   * Represents the D-Bus property <link linkend="gdbus-property-org-qemu-Display1-Audio.NSamples">"NSamples"</link>.
   *
   * Since the D-Bus property for this #GObject property is readable but not writable, it is meaningful to read from it on both the client- and service-side. It is only meaningful, however, to write to it on the service-side.
   */
  g_object_interface_install_property (iface,
    g_param_spec_uint ("nsamples", "NSamples", "NSamples", 0, G_MAXUINT32, 0, G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
  /**
...
/**
 * qemu_dbus_display1_audio_get_nsamples: (skip)
 * @object: A #QemuDBusDisplay1Audio.
 *
 * Gets the value of the <link linkend="gdbus-property-org-qemu-Display1-Audio.NSamples">"NSamples"</link> D-Bus property.
 *
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * Returns: The property value.
...
/**
 * qemu_dbus_display1_audio_set_nsamples: (skip)
 * @object: A #QemuDBusDisplay1Audio.
 * @value: The value to set.
 *
 * Sets the <link linkend="gdbus-property-org-qemu-Display1-Audio.NSamples">"NSamples"</link> D-Bus property to @value.
 *
 * Since this D-Bus property is not writable, it is only meaningful to use this function on the service-side.
 */
void
qemu_dbus_display1_audio_set_nsamples (QemuDBusDisplay1Audio *object, guint value)
{
  g_object_set (G_OBJECT (object), "nsamples", value, NULL);
}
...
static guint 
qemu_dbus_display1_audio_proxy_get_nsamples (QemuDBusDisplay1Audio *object)
{
  QemuDBusDisplay1AudioProxy *proxy = QEMU_DBUS_DISPLAY1_AUDIO_PROXY (object);
  GVariant *variant;
  guint value = 0;
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (proxy), "NSamples");
  if (variant != NULL)
    {
      value = g_variant_get_uint32 (variant);
      g_variant_unref (variant);
...
{
  iface->get_nsamples = qemu_dbus_display1_audio_proxy_get_nsamples;
...
static guint 
qemu_dbus_display1_audio_skeleton_get_nsamples (QemuDBusDisplay1Audio *object)
{
  QemuDBusDisplay1AudioSkeleton *skeleton = QEMU_DBUS_DISPLAY1_AUDIO_SKELETON (object);
  guint value;
  g_mutex_lock (&skeleton->priv->lock);
...
{
  iface->get_nsamples = qemu_dbus_display1_audio_skeleton_get_nsamples;
